...
st.title("Useful Streamlits elements")

st.link_button("Open a new tab/window to view the source code here", "https://github.com/tngyo/mini/blob/secondbranch/pages/elements.py")
